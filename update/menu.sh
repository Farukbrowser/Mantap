...
yl="\033[0;1;33m"
wh="\033[0m"
echo -e "$y                  24clanSSH MENU $wh"
echo -e "$y            Script Created By Faruk Browser $wh"
echo -e "$y-------------------------------------------------$wh"
...
echo -e "$yy 14$y. CHECK ALL IP PORTS$wh"
echo -e "$yy 15$y. CHECK ALL VPN SERVICES$wh"
echo -e "$yy 16$y. UPDATE MENU (Update)$wh"
echo -e "$yy 17$y. sl-fix (Fix SSLH+WS-TLS Error after reboot)$wh"
echo -e "$yy 18$y. Settings (Setup)$wh"
echo -e "$yy 19$y. Exit (Logout)$wh"
echo -e "$yy 20$y. copyrepo (Copy Repo Script Steady)$wh"
echo -e "$yy 21$y. menuinfo (To Get Information)$wh"
echo -e "$yy 22$y. Shadowsocks Plugin (Create Account)$wh"
echo -e "$y-------------------------------------------------$wh"
