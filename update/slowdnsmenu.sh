...
echo -e "\033[0;36m#|'....|'.||.'|..|'  |   |  .||...|'.|.   '||'....|'#\033[m"
echo -e "\033[0;36m#---------------------------------------------------#\033[m"
echo -e "\033[0;36m#\033[m \033[0;31mSlowDNS | RELAXING\033[m \033[0;36m#\033[m"
echo -e "\033[0;36m#======================================= ============#\033[m"
     echo ""
     ...
     echo -e "\033[0;36m[11]\033[m | Delete Script"
...
Opcao10 () {
    clear
    wget https://raw.githubusercontent.com/farukbrowser/Mantap/main/Slowdns/update
    chmod +x update
    bash update
}
