...
echo -e "Websocket Info : Only Cloudflare Bug && must use subdomain && Port/Bug=must be same"
echo -e "========-obfs-plugin-========="
echo -e "OBFS TLS : $tls"
...
echo -e "v2ray-plugin App Link: #://$MYIP:89/xray-plugin-universal.apk"
echo -e "Gost-plugin Application Link: #://$MYIP:89/gost-plugin-x86.zip"
echo -e "Gost-plugin App Link: #://$MYIP:89/gost-plugin-arm.zip"
echo -e "xray-plugin App Link: #://$MYIP:89/v2ray-plugin-universal.apk"
echo -e "change # to http"
echo -e "==========================
